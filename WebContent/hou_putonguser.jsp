...
<td>${us.userpwd}</td>
<td>
<a href="${pageContext.request.contextPath}/userAction/finduser.action?userid=${us.userid}">修改</a>
<a href="${pageContext.request.contextPath}/userAction/deldel.action?userid=${us.userid}">删除</a>
</td>
</tr>
</c:forEach>
</table>       
