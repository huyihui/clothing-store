...
<div class="meny">
  <h2>后台页面</h2>
  <ul>
  	<li><a href="${pageContext.request.contextPath }/hou_index.jsp">返回首页</a></li>
...
<div class="contents">
	<form action="${pageContext.request.contextPath }/productAction/upPicc.action" method="post" enctype="multipart/form-data">
		<table cellspacing="0">
		<tr><td>上传图片</td><td><input type="file" name="file1" /></td></tr>
		<tr><td></td><td><input type="hidden" name="prophoto" value=""/></td></tr>
		<tr><td>名称</td><td><input type="text" name="proname" /></td></tr>
		<tr><td>价格</td><td><input type="text" name="proprice" /></td></tr>
		<tr><td>库存</td><td><input type="text" name="procount" /></td></tr>
		<tr><td colspan="2" ><input id="input" type="submit" value="上传" /></td></tr>
		<tr><td colspan="2"><a href="${pageContext.request.contextPath }/productAction/getListPro.action">获取产品列表</a></td></tr>
		</table>
	</form>
