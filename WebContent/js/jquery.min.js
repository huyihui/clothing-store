...
<TABLE cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <TD class=titleBorder id=L_10060_2>网络访问消息:<SPAN class=TitleDescription> 无法显示此页</SPAN> </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    ...
    <TD width=400><SPAN class=explain><ID id=L_10060_3><B>解释:</B></ID></SPAN><ID id=L_10060_4> 在页面检索完成之前，请求超时。 </ID><BR><BR>
    <B><SPAN class=tryThings><ID id=L_10060_5><B>尝试下列:</B></ID></SPAN></B> 
      <UL class=TryList>
        <LI id=L_10060_6><B>刷新页:</B> 单击“刷新”按钮来再次搜索此页。超时可能是由于 Internet 拥塞造成的。
<LI id=L_10060_7><B>检查拼写:</B> 请检查您是否正确键入了网页地址。键入的网页地址不正确。
<LI id=L_10060_8><B>联系网站:</B> 您可能想要联系网站的管理员，以确认网页仍然存在。您可以使用网站主页上列出的电子邮件地址或电话号码与他们联系。

      </UL>
<ID id=L_10060_9>如果您仍然看不到请求的页面，请与您的管理员或支持人员联系。</ID> <BR><BR>
    </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    <TD noWrap width=25></TD>
    <TD width=400 id=L_10060_10><B>技术信息(提供给支持人员)</B> 
      <UL class=adminList>
        <LI id=L_10060_11>错误代码 10060: 连接超时
<LI id=L_10060_12>背景信息: 网关不能从您要访问的网站接收到及时响应。这可能表明网络阻塞，或者该网站遇到技术困难。
<LI id=L_10060_13>日期: 2016-8-30 23:54:02 [GMT]
<LI id=L_10060_14>服务器: isa
<LI id=L_10060_15>源: 防火墙
