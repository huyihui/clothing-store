...
<div class="contents">
<form action="${pageContext.request.contextPath}/userAction/updaupda.action" method="post">
...
<tr>
<td>密码</td><td><input type="text" name="userpwd" value="${user.userpwd}"/></td>
</tr>
<tr>
<td colspan="2"><input type="submit" value="提交" id="input"/></td>
</tr>
</table>       
</form>
