...
<c:forEach items="${list}" var="us" varStatus="states">
<tr>
<td>${states.count}</td>
<td>${us.username}</td>
<td>${us.userpwd}</td>
<td>
<a href="${pageContext.request.contextPath}/userAction/finduser1.action?userid=${us.userid}">修改</a>
<a href="${pageContext.request.contextPath}/userAction/deldel1.action?userid=${us.userid}">删除</a>

</td>
</tr>
</c:forEach>
<tr>
<td><a href="${pageContext.request.contextPath}/hou_manager3.jsp">添加管理员</a></td>
</tr>
</table>       
