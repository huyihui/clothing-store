...
<div class="contents">
	...
	<form action="${pageContext.request.contextPath }/productAction/updpro.action" method="post">
		...
		<table  align="center" cellspacing="0">
			...
			<tr>
				<td>照片</td>
				<td><input type="text" name="prophoto" value="${product.prophoto}"/></td>
			</tr>	
			<tr>
				<td>价格</td>
				<td><input type="text" name="proprice" value="${product.proprice}"/></td>
			</tr>
			<tr>
				<td>数量</td>
				<td><input type="text" name="procount" value="${product.procount}"/></td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<input id="input" type="submit" value="修改" />
				</td>
			</tr>	
		</table>		
