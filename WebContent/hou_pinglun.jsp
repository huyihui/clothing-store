...
<c:forEach items="${list}" var="tk" varStatus="states">
<tr>
<td>${states.count}</td>
<td>${tk.talkusername}</td>
<td>${tk.talkneirong}</td>
<td>
<a href="${pageContext.request.contextPath}/talkAction/deldel.action?talkid=${tk.talkid}">删除</a>
