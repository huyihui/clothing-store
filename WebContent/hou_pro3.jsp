...
<div class="contents">
	...
	<c:forEach items="${requestScope.list}" var="pro" varStatus="state">
		<tr>
	<td>${pro.proid}</td>
	<td>${pro.proname}</td>
	<td>${pro.prophoto}</td>
	<td>${pro.proprice}</td>
	<td>${pro.procount}</td>
	<td><a href="${pageContext.request.contextPath }/productAction/delpro.action?proid=${pro.proid}">删除</a>
	<a href="${pageContext.request.contextPath }/productAction/findprobyid.action?proid=${pro.proid}">更新</a></td>
		</tr>
